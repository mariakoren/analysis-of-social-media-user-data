...
X_train = train_set.drop(columns=["Gender"])
y_train = train_set["Gender"]
X_test = test_set.drop(columns=["Gender"])
...
plt.savefig('macierze_bledow_gender.png')
# plt.savefig('macierze_bledow_gender_scaled.png')
